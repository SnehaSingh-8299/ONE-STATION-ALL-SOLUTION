...
?>
	...
	<div class="terms py-sm-5 py-4">
		...
		<!--	<p class="font-weight-light pl-sm-4 mb-2">Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia non numquam eius
			...
			<p class="font-weight-light pl-sm-4 mb-2">If you are going to use a passage of OSAS, you need to be sure there isn't anything embarrassing hidden in the
				middle of text. All OSAS generators on the Internet tend to repeat predefined chunks as necessary</p>
			<p class="font-weight-light pl-sm-4 mb-2">first true shoping on the Internet. It uses a dictionary of over 200 websites, combined with a handful of model sentence
				structures, to generate OSAS which looks reasonable. The generated OSAS is therefore always free from repetition,
				injected humour</p>
