...
?>
	...
	<!-- help -->
	<div class="faqs-storesl py-sm-5 py-4">
		<div class="container py-xl-4 py-lg-2">
			...
			<!-- //tittle heading -->
			<!-- help content -->
			<div class="electronics-stroe-help mb-sm-5 mb-4">
				<div class="electronics-left-help">
					<h3 class="stores-head">How Can We help you</h3>
			...
			<!-- //help content -->
			<!-- Faqs -->
			<h3 class="stores-head mb-2">Top 10 Frequently asked questions</h3>
			<div class="faq-storeselectronics">
				<ul class="faq pl-4">
