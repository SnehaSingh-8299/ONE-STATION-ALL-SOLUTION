...
?>
	...
	?>
						<div class="range border-bottom py-2">
							<h3 class="electronicsits-sear-head mb-3"></h3>
							<div class="storesl-range">
								<ul>
									<li>
										<img src="admin/uimages/<?=$arr['image'];?>" height="25%" width="20%">
										&nbsp;&nbsp;&nbsp;&nbsp;
										<a href="category.php?delid=<?= $arr['id']; ?>">  <?=$arr['pname'];?>  </a>
									</li>
	...
	?>																								 
						...
						<!--<div class="left-side border-bottom py-2">
							<h3 class="electronicsits-sear-head mb-3">Discount</h3>
							<ul>
								<li>
						...
						<!--<div class="customer-rev border-bottom left-side py-2">
							<h3 class="electronicsits-sear-head mb-3">Customer Review</h3>
							<ul>
								<li>
									<a href="#">
						...
						<!-- electronics -->
						<!--<div class="left-side border-bottom py-2">
							<h3 class="electronicsits-sear-head mb-3">Electronics</h3>
							<ul>
								<li>
									<input type="checkbox" class="checked">
						...
						<!-- delivery -->
						<!--<div class="left-side border-bottom py-2">
							<h3 class="electronicsits-sear-head mb-3">Cash On Delivery</h3>
							<ul>
								<li>
									<input type="checkbox" class="checked">
						...
						<!-- arrivals -->
						<!--<div class="left-side border-bottom py-2">
							<h3 class="electronicsits-sear-head mb-3">New Arrivals</h3>
							<ul>
								<li>
									<input type="checkbox" class="checked">
						...
						<!--<div class="f-grid py-2">
							<h3 class="electronicsits-sear-head mb-3">Best Seller</h3>
