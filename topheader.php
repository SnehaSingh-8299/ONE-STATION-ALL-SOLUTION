		...
		<div class="container-fluid">
			<div class="row main-top-storesl py-2">
				<div class="col-lg-4 header-most-top">
					<p class="text-white text-lg-left text-center">Welcome to One Station All Solution
				...
				<div class="col-lg-8 header-right mt-lg-0 mt-2">
					...
					<ul>
						...
						<li class="text-center border-right text-white">
							<i class="fas fa-phone mr-2"></i> 8299769478
						</li>
						<li class="text-center border-right text-white">
							<a href="#" data-toggle="modal" data-target="#exampleModal" class="text-white">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="#" method="post">
						...
						<div class="right-storesl">
							<input type="submit" name="sub" class="form-control" value="Register">
						</div>
