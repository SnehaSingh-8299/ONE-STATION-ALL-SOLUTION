<!-- product right -->
 <?php
			$sel=mysqli_query($con,"select * from product order by dat desc limit 11");
			...
			<div class="agileinfo-ads-display col-md-9">
				<div class="wrapper">
					...
					<div class="product-sec1">
						<h3 class="heading-tittle">Leafy Vegetables</h3>
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
									<img src="admin/uimages/<?=$arr['image'];?>" alt="">
								...
								<div class="item-info-product ">
									<h4>
										<a href="single.html"><?=$arr['title'];?><?=$arr['descr'];?></a>
									</h4>
